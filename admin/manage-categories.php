            ...
            <table>
                ...
                <?php while($category = mysqli_fetch_assoc($categories)) : ?>
                    <tr>
                        ...
                        <td><a href="<?= ROOT_URL ?>controller/delete-category-controller.php?id=<?= $category['id'] ?>" class="btn sm danger">Delete</a></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <?php else : ?>
                <div class="alert__message error"><?= "không có thẻ nào đc tìm thấy!" ?></div>
            <?php endif; ?>
        </main>
    </div>
</section>
