  ...
  <section class="featured">
    <div class="container featured__container" style="display: flex;  gap: 2rem;">
      <div class="post__info" style="flex: 1;">
        ...
        ?>
        <a href="<?= ROOT_URL ?>public/category-posts.php?id=<?= $featured['category_id'] ?>" class="category__button"><?= $category['title'] ?></a>
        <span class="like-count"><?= $like_count ?> <i class="fas fa-heart"></i></span>

        <h2 class="post__title">
          <a href="<?= ROOT_URL ?>public/post.php?id=<?= $featured['id'] ?>"><?= $featured['title'] ?></a>
        </h2>
        <p class="post_body">
          <?= substr($featured['body'], 0, 300) ?><a href="<?= ROOT_URL ?>public/post.php?id=<?= $featured['id'] ?>"> - xem thêm</a>
        </p>
